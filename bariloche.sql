...
/****** Object:  Database [Hospedaje]    Script Date: 20/06/2023 18:21:29 ******/
CREATE DATABASE [Hospedaje]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Hospedaje', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Hospedaje.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Hospedaje_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Hospedaje_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Hospedaje] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [Hospedaje] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
